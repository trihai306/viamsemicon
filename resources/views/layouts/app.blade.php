    ...
    <div class="glass-nav bg-white transition-all duration-300 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
            ...
            <div class="hidden lg:flex flex-col items-end flex-shrink-0">
                ...
                <a href="tel:0528152831" class="text-xs font-semibold text-brand-main hover:text-brand-dark mt-0.5">0528.152.831</a>
            </div>
                ...
                <ul class="space-y-3 text-sm text-gray-300">
                    ...
                    <li class="flex gap-3 items-center">
                        ...
                        <span>
                            ...
                            <a href="tel:0528152831" class="hover:text-white transition-colors">0528.152.831</a>
                        </span>
                    </li>
                    <li class="flex gap-3 items-center">
